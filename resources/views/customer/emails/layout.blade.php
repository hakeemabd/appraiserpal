                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td class="six sub-columns last"
                                                        ...
                                                        <span class="template-label">{{ $title or '' }}</span>
                                                    </td>
                                            ...
                                            <tr>
                                                <td class="left-text-pad">
                                                    ...
                                                    <table class="tiny-button facebook">
                                                        <tr>
                                                            <td>
                                                                <a href="https://www.facebook.com/appraiserpal">Facebook</a>
                                                            </td>
                                                        </tr>
                                                    </table>  
                                                    {{--<br>--}}
                                        ...
                                        <table class="six columns">
                                            <tr>
                                                <td class="last right-text-pad">
                                                    ...
                                                    <p>Phone: (832) 900-7116</p>

                                                    <p>Email: <a
                                                                href="mailto:info@appraiserpal.com">info@appraiserpal.com</a>
                                                    </p>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                                ...
                                                <td align="center">
                                                    <center>
                                                        <p style="text-align:center;"><a
                                                                    href="{{ route('customer:page', ['page' => 'terms']) }}">Terms</a>
                                                            |
                                                            <a href="{{ route('customer:page', ['page' => 'privacy']) }}">Privacy</a>
                                                        </p>
                                                    </center>
                                                </td>
                                                <td class="expander"></td>
