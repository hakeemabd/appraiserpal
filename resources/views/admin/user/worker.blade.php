...
@section('form-content')
    ...
    {!! Form::materialEmail('paypal_email', (isset($model)) ? $model->paypal_email : null) !!}
    {!! Form::materialText('bank_name', (isset($model)) ? $model->bank_name : null) !!}
    {!! Form::materialNumber('account_number', (isset($model)) ? $model->account_number : null) !!}
    {!! Form::materialNumber('routing_number', (isset($model)) ? $model->routing_number : null) !!}
