    ...
    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div id="publicInfo" class="col s12">
                                    <table class="centered striped datagrid"
                                           data-source="{{route('worker:comments', ['orderId' => $order->id, 'namespace' => 'public'])}}"
                                           data-action="0">
                                        <thead>
                                        <tr>
                                ...
                                <div id="privateInfo" class="col s12">
                                    <table class="centered striped datagrid"
                                           data-source="{{route('worker:comments', ['orderId' => $order->id, 'namespace' => 'private'])}}"
                                           data-action="0">
                                        <thead>
                                        <tr>
                                            <th data-index="col_comment_file"></th>
                ...
                <div class="col s12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <table class="centered striped datagrid"
                                   data-source="{{route('worker:documents.files', ['orderId' => $order->id])}}"
                                   data-action="0">
                                <thead>
                                <tr>
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <table id="upload_documents_datatable" class="centered striped datagrid"
                                   data-source="{{route('worker:documents.uploaded.files', ['orderId' => $order->id])}}">
                                <thead>
                                <tr>
            ...
            <div class="row">
                ...
                <div id="modal-comment" class="modal">
                    <div class="modal-content">
                        ...
                        <form id="comment_form" action="{{ route('worker:comments') }}" method="POST"
        ...
        @if($btnType == 'complete')
            <div id="modal-group" class="modal">
                <div class="modal-content">
                    <h4>Sent to group</h4>
                    <form class="ajax-form" action="{{route('worker:invitation.reworking', ['orderId' => $order->id])}}"
                ...
                <div class="row right-align">
                    <div class="col s12">
                        ...
                        <ul id='order-actions' class='dropdown-content'>
                            <li>
                                <a href="{{ route('worker:invitation.complete', ['orderId' => $order->id, 'groupId' => $groupId]) }}">Complete</a>
                            </li>
            ...
            <div class="col s12">
                <div class="row right-align">
                    <div class="col s12">
                        ...
                        <ul id='order-actions' class='dropdown-content'>
                            <li>
                                <a href="{{ route('worker:invitation.finish', ['orderId' => $order->id, 'groupId' => $groupId]) }}">Finish</a>
                            </li>
                        </ul>
                    </div>
                </div>
